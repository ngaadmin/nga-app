...
/** Money wins — Actions and Savings badges. Lives in Advanced Money. */
export function MoneyMilestonesSection({
  ...
  return (
    <section
      aria-labelledby={hideHeading ? undefined : "money-milestones-heading"}
      aria-label={hideHeading ? "Money milestone badges" : undefined}
