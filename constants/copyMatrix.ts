  ...
  dashboard: {
    ...
    vault: {
      ...
      savings: {
        ...
        openAllocation: "Tap to split across goals",
        hideAllocation: "Hide split view",
        changeGoalAmount: "Change Goal Amount",
        spendThisMoney: "Spend this money",
        changeGoalTargetHint: "Set a new target amount for this goal.",
        goalTargetUpdatedTemplate: "Updated {goal} target to {amount}",
        manageSavingsGoals: "Manage Savings Goals",
        goalTargetShort: "Target",
        noGoalsYet: "No savings goals yet.",
        noSavingsToAllocate: "Nothing left to assign — add savings to your Save Jar first.",
        goalAtTargetHint: "This goal hit its target. Nice work!",
