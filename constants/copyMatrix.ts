  ...
  dashboard: {
    ...
    vault: {
      ...
      savings: {
        ...
        splitAcrossGoals: "Split across savings goals",
        hideAllocation: "Hide split view",
        changeGoalAmount: "Set goal amount",
        changeGoalTarget: "Change target",
        ...
        moveOutOfTemplate: "Move out of {name}",
        moveIntoTemplate: "Move into {name}",
        moveConfirm: "Move",
        movedFromGoalTemplate: "Moved {amount} from {goal} to {destination}",
