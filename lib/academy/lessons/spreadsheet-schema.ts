...
export const GAME_ARCHETYPE_TO_TYPE: Record<string, string> = {
  ...
  "sentence finisher": "binary-choice",
  ...
  "budget balance": "custom:budget-wallet",
  "the allocation slider": "custom:reserve-slider",
  "allocation slider": "custom:reserve-slider",
  "the sequence stack": "custom:rank-stack",
  "sequence stack": "custom:rank-stack",
