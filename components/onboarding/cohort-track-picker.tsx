  ...
  return (
    <section className="flex min-h-0 flex-1 flex-col justify-start py-3 sm:pt-8 sm:pb-12">
      <div className="mx-auto w-full max-w-4xl px-3 sm:px-0">
        <h1 className="mb-3 text-center font-heading text-2xl font-extrabold text-nga-primary sm:mb-6 sm:text-3xl">
          Pick your track
        </h1>
        <div className="grid grid-cols-1 gap-2 sm:grid-cols-3 sm:items-start sm:gap-8">
