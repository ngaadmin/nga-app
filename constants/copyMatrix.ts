  ...
  dashboard: {
    ...
    vault: {
      ...
      budget: {
        ...
        allocatePoolCta: "Allocate",
        fullyAllocatedLabel: "Fully Allocated!",
        lockItIn: "Allocate Now",
        move: "Move",
        spendAction: "Spend",
        moveAction: "Move",
        deleteBucket: "Delete jar",
        deleteBucketDisabledHint: "Empty this jar before deleting it.",
        spendCategoryLabel: "Category",
        spendAmountLabel: "Amount",
        spendConfirm: "Spend",
        actionCancel: "Cancel",
        bucketEmptyHint: "Nothing in this jar yet.",
      ...
      savings: {
        ...
        toPutTowardGoalsLabel: "to put toward goals",
        addAGoal: "Add a goal",
