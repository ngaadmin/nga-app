...
const M1_L1_BASE_SCREENS: ScreenConfig[] = [
  {
    type: "word-drop",
    id: "hook-word-drop",
    narrativeBefore: "Holly made $25 from her weekend chores. At the mall, her friends are all showing off their new eyelash extensions and she feels the sudden urge to get hers done too. Her brain tricks her into thinking the cash must be",
    ...
    correctOption: "Spent",
    wrongError: "Not quite! Holly's friends are showing off — what's her brain pushing her to do with that $25?",
  },
  {
    type: "binary-choice",
    id: "short-fun-reality",
    prompt: "Holly gets her eyelashes done right away with the $25 but ten minutes later...",
    optionA: {
  ...
  },
  {
    ...
    intro: "Holly's $25 is gone and she only had a few minutes of excitement. Tap these items to see the difference between short fun and longer fun!",
    ...
    items: [
      {
        id: "glow-in-the-dark-slime-k",
        emoji: "🧪",
        label: "Glow-in-the-dark slime kit",
        bucket: "short",
      },
      {
        id: "candy-salad",
  ...
  },
  {
    type: "binary-choice",
    id: "countdown-trap",
    prompt: "Holly's playing online and a game alert flashes: \"Limited time - new skin 70% off! 15 MINUTES LEFT!\" Why is the game rushing her?",
    optionA: {
    ...
    wrongError: "Don't fall for the countdown! They're rushing Holly so she won't stop to think if she really wants to spend her money on it. Try again!",
    errorStyle: "banner",
  },
  {
    type: "hold-to-fill",
    id: "impulse-pause",
    narrative: "Holly isn't sure but her friends are blowing up the in-game chat. They're all bragging that they just bought it. Let's give Holly some time to think, but silencing the chat alerts.",
  ...
  },
  {
    ...
    id: "resolution",
    narrative: "Holly chooses to keep her money instead of giving in to the rush. Tap to collect bonus 50 XP for successfully staying in control of spending.",
    bonusXp: 50,
    ...
    items: [
      {
        id: "giant-bubble-tea",
        emoji: "🧋",
        label: "Giant bubble tea",
        bucket: "short",
      },
      {
        id: "cheap-glow-sticks-led-to",
        emoji: "🪄",
        label: "Cheap glow sticks / LED toys",
        bucket: "short",
      },
      {
        id: "wireless-speaker-for-han",
        emoji: "🔊",
        label: "Wireless speaker for hangouts",
        bucket: "long",
      },
      {
        id: "journal-good-pen-set",
        emoji: "📓",
...
const MAVERICK_OVERRIDES: ScreenOverrideMap = {
  "hook-word-drop": {
    narrativeBefore: "Dash just got $40 cash from a quick delivery gig. He opens the marketplace app and sees the exact wireless earbuds he's been tracking. His brain tricks him into thinking the cash must be",
    wrongError: "Not quite! Dash spotted those earbuds — what's his brain pushing him to do with that $40?",
  },
  "short-fun-reality": {
    prompt: "Dash buys the wireless earbuds for $40 on the marketplace and picks them up straight away. He's super happy with how they sound at first but a few hours later...",
    wrongError: "If only! On the marketplace, once you pay and take the item, the money is gone. No instant refunds just for buying fast. Try again!",
    optionA: {
  ...
  "tap-short-vs-long": {
    intro: "Dash's $40 is gone after buying the earbuds and he only had a short burst of satisfaction. Tap these items to see the difference between things that give short fun and things that give more fun for longer!",
    items: [
      {
        id: "energy-drink-snack",
        emoji: "⚡",
        label: "Energy drink + snack",
        bucket: "short",
      },
      {
        id: "scratch-it-lottery-ticke",
        emoji: "🎫",
      ...
      {
        id: "multi-tool-pocket-knife",
        emoji: "🔧",
        label: "Multi-tool / pocket knife",
        bucket: "long",
      },
    ],
  },
  ...
  "countdown-trap": {
    prompt: "Later that day Dash receives a text message: \"Flash sale on premium bike lights – huge discount but ONLY 10 MINUTES LEFT!\" Why is the offer rushing him?",
    wrongError: "Don't fall for the countdown! They're rushing Dash so he won't stop to think if he really wants to spend his money on it. Try again!",
    optionA: {
  ...
  "impulse-pause": {
    narrative: "If dash had time to think, he'd remember how a similar item he bought last month dropped in price the very next day. Hit the 'pause' button so Dash can decide if he really needs the item right now.",
